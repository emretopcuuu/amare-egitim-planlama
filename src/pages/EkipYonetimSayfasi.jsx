...
const MODULLER = [
  {
    ...
    kisaltma: 'HBB',
    aciklama: {
      tr: 'Yeni iş ortaklarının hızlı başlangıç bonusu süreçlerini izle.',
      en: 'Track quick start bonus progress for new partners.',
      de: 'Verfolge den Schnellstart-Bonusverlauf neuer Partner.',
      nl: 'Volg de snelstart bonusvoortgang van nieuwe partners.',
    },
    icon: Rocket,
    aktif: true,
