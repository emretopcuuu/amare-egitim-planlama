...
import {
  LogOut, Users, Calendar, Settings, Home,
        ...
        <div className="container mx-auto flex items-center justify-between gap-3 flex-wrap">
          <div className="flex items-center gap-3">
            <button onClick={() => navigate('/')}
              ...
              className="flex items-center bg-gray-700 hover:bg-gray-600 px-3 py-2 rounded-lg transition-colors text-sm font-semibold">
              <Home className="w-4 h-4 mr-1.5" />
              <span className="hidden sm:inline">Anasayfa</span>
            </button>
            <h1 className="text-xl sm:text-2xl font-bold">One Team Eğitim Komisyonu Admin Paneli</h1>
          </div>
