-- yeni_kamp_hazirla(): denetim (E-serisi) yeni tablolarını da temizle. E2 taahhut
-- + E11 eylul_dis reset'te kalıyordu (yeni kampta bayat kalırdı). Gövde 0103 ile
-- birebir aynı; yalnız FAZ 1-6 blok silmelerine taahhut + eylul_dis eklendi.
