...
export default async function AkisDizisi() {
  ...
  const adimlar: Adim[] = [
    ...
    // Hedef adımı kaldırıldı: onboarding hedefi Pusula'dan sonra OTOMATİK açılır
    // (akis.ts 3b), admin bayrağı gerektirmez. Eski elle "hedef_acik" düğmesi
    // işlevsizdi ve kafa karıştırıyordu — panelden çıkarıldı.
    ...(dalgalar ?? []).map((d) => ({
