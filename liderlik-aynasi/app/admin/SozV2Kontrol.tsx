...
const t = tr.admin.sozV2;

// SÖZ v2 (kapanış) admin: pencereyi aç/kapa + tamamlanma. Rapordan SONRA açılır.
export default function SozV2Kontrol() {
  ...
  const yukle = useCallback(async () => {
    try {
      const res = await fetch("/api/admin/soz-v2");
