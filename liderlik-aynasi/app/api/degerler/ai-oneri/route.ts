  ...
  try {
    const msg = await client.messages.create({
      ...
      messages: [
        {
          role: "user",
          content: `Sen bir değer analiz uzmanısın. Aşağıdaki kişisel yansıma cevaplarını analiz et ve bu kişide en güçlü öne çıkan TAM 5 değeri seç.
...
{"degerler": ["Değer1", "Değer2", "Değer3", "Değer4", "Değer5"]}`,
    ...
    const parsed = JSON.parse(raw) as { degerler: string[] };
