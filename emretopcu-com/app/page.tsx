...
const EPOSTA = "s.emretopcu@gmail.com";
...
// Gerçek eğitim arşivinden seçme başlıklar (One Team Global eğitim kütüphanesi).
const EGITIMLER = [
  {
    yil: "2020",
...
function Hero() {
  return (
    <section className="relative flex min-h-[100dvh] items-center overflow-hidden">
      {/* Sahne ışığı: tek vurgu renginin çok düşük yoğunluklu yıkaması */}
      <div
        aria-hidden
      ...
      <div className="mx-auto grid w-full max-w-6xl gap-14 px-6 pt-24 pb-16 md:grid-cols-12 md:items-center">
        <div className="md:col-span-7">
          ...
          >
            One Team Global bünyesinde ekipler kuruyor, liderler yetiştiriyor
            ve bu işi sistemle yapıyorum.
          </p>
          <div
        ...
        >
          {/* TODO: Buraya gerçek portre gelecek: /public/portre.jpg (1200x1500),
              sonra bu blok next/image ile değiştirilecek. Fotoğraf gelene kadar
              marka monogramı paneli gösteriyoruz. */}
          <div className="relative mx-auto aspect-[4/5] w-full max-w-sm overflow-hidden rounded-2xl border border-white/10 bg-ink-2">
            ...
            <div className="absolute inset-x-0 bottom-0 border-t border-white/10 bg-ink/60 px-5 py-4 backdrop-blur-sm">
              <p className="text-sm text-mist">Ankara, Türkiye</p>
              <p className="text-sm text-bone">One Team Global lideri</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="mx-auto max-w-3xl px-6">
        <Reveal>
          <h2 className="text-3xl font-semibold tracking-tight md:text-4xl">
            İşim insan, aracım sistem.
          </h2>
        </Reveal>
        <Reveal delay={0.1}>
          <p className="mt-7 text-lg leading-relaxed text-mist">
            Yıllardır network marketing sahasındayım. Ankara merkezli
            ekibimle One Team Global çatısı altında çalışıyorum. Bu işte en
            çok inandığım şey şu: kalıcı büyüme karizmayla değil, herkesin
            uygulayabildiği net bir sistemle olur.
          </p>
        </Reveal>
        <Reveal delay={0.18}>
          <p className="mt-5 text-lg leading-relaxed text-mist">
            2020&apos;den beri yüzlerce eğitim verdim, liderlik kampları
            tasarladım ve ekibim için kendi dijital araçlarımızı geliştirdim.
            Sahnede anlattığım her şeyi önce kendi ekibimde denerim; işe
            yaramayanı anlatmam.
          </p>
        </Reveal>
      </div>
            ...
            {EGITIMLER.map((egitim, i) => (
              <article
                ...
                className={`w-[280px] shrink-0 snap-start rounded-2xl border border-white/10 p-6 transition-colors hover:border-white/25 md:w-[320px] ${
                  i % 3 === 0 ? "bg-gradient-to-br from-buz/10 to-ink-2" : "bg-ink-2"
                }`}
              >
            ...
            <div className="relative grid gap-12 md:grid-cols-2 md:items-center">
              <div>
                ...
                <p className="mt-5 max-w-[46ch] leading-relaxed text-mist">
                  Sapanca kampı için sıfırdan geliştirdiğimiz 360° liderlik
                  değerlendirme ve kişisel gelişim uygulaması. Üç gün boyunca
                  29 liderin cebinde çalıştı: görevler, gözlemler ve yapay
                  zeka destekli kişisel pusula.
                </p>
                <a
                  href="https://ayna.oneteamglobal.ai"
                  target="_blank"
              ...
              <dl className="grid grid-cols-2 gap-x-8 gap-y-10">
                <div>
                  <dt className="text-sm text-mist">Katılımcı</dt>
                  <dd className="mt-1 text-4xl font-semibold tracking-tight text-bone">
                    29 lider
                  </dd>
                </div>
                <div>
                  <dt className="text-sm text-mist">Süre</dt>
                  <dd className="mt-1 text-4xl font-semibold tracking-tight text-bone">
                    3 gün
                  </dd>
                </div>
                <div>
                  <dt className="text-sm text-mist">Değerlendirme</dt>
                  <dd className="mt-1 text-4xl font-semibold tracking-tight text-bone">
                    360°
                  </dd>
                </div>
                <div>
                  <dt className="text-sm text-mist">Kuruluş</dt>
                  <dd className="mt-1 text-4xl font-semibold tracking-tight text-bone">
                    2026
                  </dd>
                </div>
